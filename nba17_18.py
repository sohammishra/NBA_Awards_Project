...
csv_file = open('nba18.csv', 'w', encoding = 'utf-8', newline = '')
...
time.sleep(3)
driver.find_element_by_xpath('/html/body/main/div[2]/div/div[2]/div/div/div[1]/div[1]/div/div/label/select/option[3]').click()
time.sleep(3)
